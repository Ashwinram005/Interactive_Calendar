  ...
  return (
    <div className="rounded-3xl bg-white p-4 shadow-paper sm:p-5 lg:rounded-[1.4rem] lg:p-3.5">
      ...
      <textarea
        ...
        className="mt-3 h-32 w-full resize-none rounded-2xl border border-zinc-300 bg-zinc-50 p-4 text-sm text-zinc-700 outline-none transition focus:border-accent focus:ring-2 focus:ring-accent/30 sm:h-36 lg:h-24"
